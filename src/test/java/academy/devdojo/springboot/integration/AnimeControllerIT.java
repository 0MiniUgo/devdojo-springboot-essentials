...
public class AnimeControllerIT {
    ...
    private static final DevDojoUser USER = DevDojoUser.builder()
            .name("Rick Games")
            .password("{bcrypt}$2a$10$rUfmSpWtinXcWZ6yGuWiUey9EpjfLW0Cp9EUQBSAsv9w0JgIGAnH6")
            .username("Rick")
    ...
    static class Config{
        ...
        public TestRestTemplate testRestTemplateRoleUserCreator(@Value("${local.server.port}") int port){
            ...
            RestTemplateBuilder restTemplateBuilder = new RestTemplateBuilder()
                    ...
                    .basicAuthentication("Rick", "Senha");
    ...
    void findByName_ReturnsEmptyList_WhenAnimeIsNotFound() {
        ...
        List<Anime> animes = testRestTemplateRoleUser.exchange("/animes/find?name=notExists", HttpMethod.GET, null,
                new ParameterizedTypeReference<List<Anime>>() {
                }).getBody();
    ...
    void replace_UpdatesAnime_WhenSuccessful() {
        ...
        ResponseEntity<Void> animeResponseEntity
                = testRestTemplateRoleUser.exchange("/animes", HttpMethod.PUT, new HttpEntity<>(savedAnime), Void.class);
    ...
    void delete_Returns403_WhenUserIsNotAdmin() {
        ...
        Anime savedAnime = animeRepository.save(AnimeCreator.createAnimeToBeSaved());
        ResponseEntity<Void> animeResponseEntity
                = testRestTemplateRoleUser.exchange
                ("/animes/admin/{id}",
                        HttpMethod.DELETE,
                        null,
                        Void.class,
